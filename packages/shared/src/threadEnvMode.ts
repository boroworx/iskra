import type { ThreadEnvMode } from "@iskra/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in iskra.json > global server setting.
 *
 ...
 * source that outranks iskra.json decided, or the file read settled. While
