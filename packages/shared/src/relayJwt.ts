...
export const RELAY_LINK_PROOF_TYP = "iskra-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "iskra-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "iskra-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "iskra-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "iskra-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "iskra-env-activity+jwt";
