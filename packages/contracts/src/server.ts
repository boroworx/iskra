...
/**
 * A palette the environment's machine publishes for Iskra to follow, read
 ...
 * over as a coherent Iskra palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `@iskra/cli` package to install (never a dist-tag, so
