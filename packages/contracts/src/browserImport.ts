 ...
 * machine into an IskraCode browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Iskra profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Iskra Full Disk Access in System Settings → Privacy & Security, then retry.",
