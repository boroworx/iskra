...
import { IskraProjectFile } from "./iskraProjectFile.ts";

const decode = Schema.decodeUnknownSync(IskraProjectFile);

describe("IskraProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://iskra.sh/schema/iskra.json",
