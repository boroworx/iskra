...
import { RelayManagedEndpoint } from "@iskra/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@iskra/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@iskra/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
