import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@iskra/contracts";
...
}>("@iskra/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof ORCHESTRATION_WS_METHODS.subscribeChannel
  | typeof ORCHESTRATION_WS_METHODS.subscribeCard
...
}>("@iskra/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
