import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@iskra/contracts";
import { resolveRemotePairingTarget } from "@iskra/shared/remote";
...
>()("@iskra/client-runtime/connection/onboarding/ConnectionOnboarding") {}
