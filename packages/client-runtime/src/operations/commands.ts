...
/** A person approving a coordinator's latest plan revision; its children are created ready. */
export const approveCardPlan = command("approveCardPlan", "card.plan.approve");
/** A person overriding a finished card's outcome, with a note saying why. */
export const setCardOutcome = command("setCardOutcome", "card.outcome.set");
