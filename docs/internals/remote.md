...
Tailscale, SSH, and Iskra Connect change how the client reaches that server; they do
...
connect. This is possible because the desktop renderer is not served by the backend: the `iskra://`
