...
Terms whose meaning matters across Iskra. Architecture and lifecycle constraints belong in the
...
| Iskra home        | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Iskra controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into Iskra operations and events.                    |
