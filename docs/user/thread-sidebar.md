...
When you change a new thread's project, Iskra stays in the current environment
...
If dragging is unavailable for one environment, update the Iskra server running in that
