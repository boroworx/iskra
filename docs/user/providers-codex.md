...
Both instances must use the same **CODEX_HOME path**. Iskra prepares the shared
...
Choose the other account from the thread's model picker. Iskra offers compatible
