...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-iskra/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "@iskra/client-runtime",
              message:
                "Import from an explicit @iskra/client-runtime/* subpath. The package has no root export.",
            },
            {
      ...
      "iskra/no-global-process-runtime": "error",
      "iskra/no-inline-schema-compile": "warn",
      "iskra/no-manual-effect-runtime-in-tests": "error",
      "iskra/no-native-title-tooltip": "error",
      "iskra/namespace-node-imports": "error",
    },
    overrides: [
      {
        // The one place that reads the host platform to seed the injected references.
        files: ["packages/shared/src/hostProcess.ts"],
        rules: { "iskra/no-global-process-runtime": "off" },
      },
      {
        files: ["apps/mobile/src/**"],
        rules: { "iskra/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        rules: { "iskra/no-hermes-unsupported-array-methods": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/IskraComposerEditor.ios.tsx",
          "apps/mobile/src/native/IskraComposerEditor.native.tsx",
        ],
        rules: {
          "iskra/no-mobile-uniwind-theme-escape-hatches": ["error", { allowUniwindTheme: true }],
        },
      },
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "iskra/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
