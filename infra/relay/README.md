...
> [!NOTE]
> Sign in to Iskra Connect from the app under Settings > Connections.

The relay is the hosted control plane for Iskra Connect. It helps clients discover and connect to
...
- Linking Iskra environments to a cloud account.
