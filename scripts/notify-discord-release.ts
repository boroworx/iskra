  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Iskra prerelease is available for nightly testers."
          : "A new Iskra latest release is available.",
...
).pipe(Command.withDescription("Post an IskraCode release announcement to Discord."));
