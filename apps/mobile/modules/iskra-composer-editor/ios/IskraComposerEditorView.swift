...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "iskra-composer-paste"
  ...
  override func paste(_ sender: Any?) {
    ...
    let pasteboard = UIPasteboard.general
    let context = IskraComposerClipboard.read()
    if !context["fragment", default: ""].isEmpty || context["html", default: ""].contains("data-iskra-context-fragment=") {
  ...
  override func copy(_ sender: Any?) {
    ...
    IskraComposerClipboard.write(text: serializedText(in: selectedRange), fragment: clipboardFragment)
  }
...
public final class IskraComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate, UIGestureRecognizerDelegate {
  ...
  private func renderChip(
    ...
    // Kept in step with `IskraContextChipVectorIcon` in the markdown module: a chip drawn here and
