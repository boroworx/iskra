...
final class IskraPresentationSources {
  private class Entry {
...
final class IskraPresentationSourceView: ExpoView {
  weak var sources: IskraPresentationSources?
  var identifier = "" {
    didSet {
...
final class IskraContextSheetSizeView: ExpoView {
  ...
  private func updateSheet() {
    ...
    while let current = responder {
      if let controller = current as? UIViewController,
        ...
        let identifier = UISheetPresentationController.Detent.Identifier("iskra-context-content")
