...
static NSDictionary *IskraContextChipPayload(NSString *uri)
{
...
static UIColor *IskraContextChipColor(NSString *hex)
{
  unsigned int rgb = 0;
...
static UIColor *IskraContextChipBlend(UIColor *accent, UIColor *base, CGFloat weight)
{
...
static UIImage *IskraContextChipVectorIcon(NSString *symbol, CGFloat size, UIColor *color)
{
...
static inline CGRect IskraContextChipBounds(UIFont *font, CGSize size)
{
...
static inline NSAttributedString *IskraMarkdownTextAttachmentString(
...
static UIFont *IskraContextChipFont(NSDictionary *payload)
{
  CGFloat size = MAX(10, MIN(40, [payload[@"fontSize"] doubleValue]));
  return [UIFont fontWithName:@"IBMPlexSans-Medium" size:size]
    ?: [UIFont systemFontOfSize:size weight:UIFontWeightMedium];
}

static inline CGSize IskraContextChipSize(NSDictionary *payload, CGFloat maximumWidth)
{
  UIFont *font = IskraContextChipFont(payload);
...
static inline UIImage *IskraContextChipImage(NSDictionary *payload, CGSize size, UIImage *fileIcon)
{
  ...
  UIColor *accent = IskraContextChipColor(payload[@"accent"]);
  UIColor *foreground = IskraContextChipBlend(accent, IskraContextChipColor(payload[@"foreground"]), 0.22);
  UIColor *border = IskraContextChipBlend(accent, IskraContextChipColor(payload[@"border"]), 0.34);
  ...
  UIImage *image = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
    ...
    UIImage *icon = fileIcon
        ?: IskraContextChipVectorIcon(payload[@"symbol"], iconSize, foreground)
