...
#import "IskraMarkdownTextRunComponentDescriptor.h"
...
@interface IskraMarkdownTextRun () <RCTIskraMarkdownTextRunViewProtocol>

@end

@implementation IskraMarkdownTextRun {
  NSString * _text;
...
{
    return concreteComponentDescriptorProvider<IskraMarkdownTextRunComponentDescriptor>();
}

- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const IskraMarkdownTextRunProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  const auto &oldViewProps = *std::static_pointer_cast<IskraMarkdownTextRunProps const>(_props);
  const auto &newViewProps = *std::static_pointer_cast<IskraMarkdownTextRunProps const>(props);
...
- (nullable UIMenu *)contextMenu
{
  ...
  __weak IskraMarkdownTextRun *weakSelf = self;
...
- (void)onContextMenuAction:(NSString *)actionIdentifier
{
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::IskraMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onContextMenuAction(facebook::react::IskraMarkdownTextRunEventEmitter::OnContextMenuAction{
...
- (void)onPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::IskraMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onPress(facebook::react::IskraMarkdownTextRunEventEmitter::OnPress{});
  }
}
...
- (void)onLongPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::IskraMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onLongPress(facebook::react::IskraMarkdownTextRunEventEmitter::OnLongPress{});
  }
}
...
Class<RCTComponentViewProtocol> IskraMarkdownTextRunCls(void)
{
    return IskraMarkdownTextRun.class;
}
