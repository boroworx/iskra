...
interface IskraMarkdownTextSelectionNativeModule {
...
const nativeModule = requireOptionalNativeModule<IskraMarkdownTextSelectionNativeModule>(
  "IskraMarkdownTextSelection",
);
