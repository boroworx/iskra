...
import IskraMarkdownTextRunNativeComponent from "./IskraMarkdownTextRunNativeComponent";
import IskraMarkdownTextNativeComponent from "./IskraMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <IskraMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <IskraMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
