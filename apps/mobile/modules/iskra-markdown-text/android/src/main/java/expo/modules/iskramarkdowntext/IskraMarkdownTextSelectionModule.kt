package expo.modules.iskramarkdowntext
...
private fun contextClipData(selectedText: String, fragment: String): ClipData {
  ...
  return ClipData.newHtmlText(
    null,
    selectedText,
    "<pre data-iskra-context-fragment=\"$attribute\">$escaped</pre>"
  )
}
...
class IskraMarkdownTextSelectionModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    Name("IskraMarkdownTextSelection")
    ...
    Function("renderContextChip") { payloadJson: String ->
      ...
      val chip = IskraContextChip(
        ...
        colors = IskraContextChip.Colors(
          accent = IskraContextChip.color(payload.optString("accent"), Color.GRAY),
          foreground = IskraContextChip.color(payload.optString("foreground"), Color.BLACK),
          border = IskraContextChip.color(payload.optString("border"), Color.GRAY)
        ),
