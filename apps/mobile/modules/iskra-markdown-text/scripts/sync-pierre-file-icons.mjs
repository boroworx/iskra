...
const customSprite = webIconSource.match(/const ISKRA_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the Iskra Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "iskra-file-icon-agents",
  pnpm: "iskra-file-icon-pnpm",
  video: "iskra-file-icon-video",
};
