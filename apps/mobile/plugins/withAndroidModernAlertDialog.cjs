...
// text, --color-primary buttons, IBM Plex Sans type. The @font resources referenced
    ...
    resources.style.push(
      {
        ...
        item: [
          ...
          { _: "@font/xml_ibm_plex_sans_regular", $: { name: "android:fontFamily" } },
      ...
      },
      {
        ...
        item: [
          { _: "@font/ibm_plex_sans_500medium", $: { name: "android:fontFamily" } },
