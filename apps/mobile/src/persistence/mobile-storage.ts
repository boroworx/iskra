...
const CONNECTIONS_KEY = "iskra.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "iskra.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "iskra.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "iskra.recent-thread-shortcuts";
...
>()("@iskra/mobile/persistence/MobileStorage") {}
