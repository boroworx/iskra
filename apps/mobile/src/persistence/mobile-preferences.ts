...
import type { SidebarProjectGroupingMode } from "@iskra/contracts";
...
const PREFERENCES_KEY = "iskra.preferences";
const PREFERENCES_FALLBACK_KEY = "iskra.preferences.fallback";
...
>()("@iskra/mobile/persistence/MobilePreferencesStore") {}
