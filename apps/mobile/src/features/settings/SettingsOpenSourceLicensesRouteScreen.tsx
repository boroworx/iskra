    ...
    >
      <View className="flex-row items-start gap-3">
        <View className="min-w-0 flex-1 gap-1">
          <Text className="text-base font-iskra-medium text-foreground" numberOfLines={2}>
            {props.entry.name}
          </Text>
        ...
        ListHeaderComponent={
          <View className="gap-4 px-5 pt-4 pb-5">
            <Text className="text-base leading-normal text-foreground-muted">
              Notices for dependencies, assets, and optional tools used by Iskra Mobile.
            </Text>
            <TextInput
    ...
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      >
        <View className="gap-2 px-1">
          <Text className="text-2xl font-iskra-bold text-foreground">{entry.name}</Text>
          <Text className="text-base leading-normal text-foreground-muted">
          ...
          {sourceUrl ? (
            ...
            >
              <Text className="font-iskra-medium text-primary">Project source</Text>
              <SymbolView
                name="arrow.up.right"
                size={16}
