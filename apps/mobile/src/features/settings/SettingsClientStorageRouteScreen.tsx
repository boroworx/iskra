...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@iskra/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-iskra-medium tabular-nums text-danger-foreground" numberOfLines={1}>
