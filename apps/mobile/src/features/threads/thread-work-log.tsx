...
import type { EnvironmentId, ToolActivityIcon } from "@iskra/contracts";
...
type WorkContentIcon = AppSymbolName | "browser" | "device" | "iskra" | "pull-request";
      ...
      >
        <View className="min-h-8 flex-row items-center gap-1.5">
            ...
            <>
              ...
              <Text
                className={cn(
                  ...
                  iconIsDestructive && "font-iskra-medium text-adaptive-rose-600-400",
                )}
          ...
          <View className="shrink-0 flex-row items-center gap-px">
            {props.copied ? (
              <Text className="pr-1 font-iskra-medium text-3xs text-adaptive-emerald-600-400">
                Copied
              </Text>
            ) : null}
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@iskra/contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
      ...
      >
        <View className="flex-row items-center gap-2">
          ...
          <View className="min-w-0 flex-1 gap-0.5">
            <Text
              key={props.rowSizing.textSizeKey}
              className="font-iskra-medium text-sm text-foreground"
              numberOfLines={1}
            >
              {summary.title}
            </Text>
