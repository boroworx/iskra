import { type KnownTerminalSession } from "@iskra/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@iskra/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@iskra/shared/terminalLabels";
