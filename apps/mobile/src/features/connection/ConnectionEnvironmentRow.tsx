...
import { type EnvironmentId, resolveEnvironmentMachineKind } from "@iskra/contracts";
        ...
        >
          {props.environment.isRelayManaged ? (
            <Text className="text-sm text-foreground-muted">
              Managed by Iskra Connect. Tunnel details update automatically.
            </Text>
          ) : (
            <>
              <View className="gap-1.5">
                <Text className="text-2xs font-iskra-bold tracking-[0.8px] uppercase text-foreground-muted">
                  Label
                </Text>
                <TextInput
            ...
            {props.environment.isRelayManaged ? null : (
              ...
              >
                <SymbolView
                  ...
                  type="monochrome"
                />
                <Text className="text-xs font-iskra-bold tracking-[0.8px] uppercase text-primary-foreground">
                  Save
                </Text>
              </Pressable>
            )}
