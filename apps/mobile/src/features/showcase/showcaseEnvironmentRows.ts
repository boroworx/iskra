...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.iskra.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.iskra.sh",
  wsBaseUrl: "wss://pocket-pi.iskra.sh",
  providerKind: "iskra_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.iskra.sh",
    isRelayManaged: true,
    isEnabled: true,
