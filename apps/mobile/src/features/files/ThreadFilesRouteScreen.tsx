...
import { EnvironmentId, type ProjectReadFileResult, ThreadId } from "@iskra/contracts";
    ...
    <View className="flex-1 bg-sheet">
      {props.truncated ? (
        <View className="border-b border-warning-border bg-warning px-4 py-2">
          <Text className="text-2xs font-iskra-bold uppercase text-warning-foreground">
            Partial file
          </Text>
