...
function RootStackLayout(props: {
  ...
  // Presents the Iskra Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-iskra-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-iskra-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
