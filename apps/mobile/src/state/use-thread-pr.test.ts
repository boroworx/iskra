import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@iskra/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/boroworx/iskra/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "boroworx/iskra",
    number: 1,
    url: "https://github.com/boroworx/iskra/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/boroworx/iskra/pull/2" };
