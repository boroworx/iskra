...
import { foldUserInputActivities } from "@iskra/client-runtime/work-log/user-input";
import * as Schema from "effect/Schema";
import {
  requestKindFromRequestType,
  type PendingApproval,
} from "@iskra/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload, isToolLifecycleItemType } from "@iskra/contracts";
import type {
...
import { extractToolActivityPresentation } from "@iskra/client-runtime/work-log/tool-presentation";
import { commandProgramName } from "@iskra/client-runtime/work-log/command-label";

import * as Arr from "effect/Array";
import * as Order from "effect/Order";

export type { PendingApproval, PendingUserInput } from "@iskra/client-runtime/pending-requests";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@iskra/contracts").ToolActivitySurface;
  toolIcon?: import("@iskra/contracts").ToolActivityIcon;
  toolSource?: import("@iskra/contracts").ToolActivitySource;
...
export type ThreadFeedEntry =
  ...
  | {
      ...
      readonly summaryToolIcon?: "browser" | "device" | "iskra" | "pull-request";
