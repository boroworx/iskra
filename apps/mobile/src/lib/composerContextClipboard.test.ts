...
import { ComposerContextId, EnvironmentId } from "@iskra/contracts";
...
const clipboard = {
  text: "![Checkout](iskra-context://v1/image/image-source) [Build](iskra-context://v1/terminal/terminal-source)",
