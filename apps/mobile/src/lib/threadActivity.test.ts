  ...
  it.each([
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "iskra", tool: "preview_navigate" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "iskra", tool: "task_status" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "mcp__iskra__preview_snapshot",
      item: undefined,
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "iskra", tool: "preview_click" },
      status: undefined,
          ...
          makeActivity({
            ...
            payload: {
              ...
              ...(index < commandCount
                ...
                : {
                    itemType: "mcp_tool_call",
                    data: { item: { server: "iskra", tool: "preview_click" } },
                  }),
            },
          }),
        ),
