...
describe("resolveMarkdownMediaPreview", () => {
  ...
  it("serves a linked Iskra attachment file in place like any other host path", () => {
    const path =
      "/home/demo/.iskra/userdata/attachments/11111111-1111-4111-8111-111111111111-mp4.mp4";
