...
import { ConnectionTransientError } from "@iskra/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "iskra.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "iskra.connections";
