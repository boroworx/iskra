...
import type { PullRequestMergeMethod } from "@iskra/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "iskra:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "iskra:renderer-state:v8",
  "iskra:renderer-state:v7",
  "iskra:renderer-state:v6",
  "iskra:renderer-state:v5",
  "iskra:renderer-state:v4",
  "iskra:renderer-state:v3",
