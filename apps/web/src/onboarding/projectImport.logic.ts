import { findProjectByPath } from "@iskra/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@iskra/contracts";
