import type { EnvironmentId, PullRequestLinkedThreadsResult } from "@iskra/contracts";
...
const COMMAND_PALETTE_OPEN_EVENT = "iskra:open-command-palette";

export interface CommandPaletteOpenDetail {
  readonly open?: "add-project";
