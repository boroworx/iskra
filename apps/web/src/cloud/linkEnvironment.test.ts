...
import { RelayWebClientId } from "@iskra/contracts/relay";
...
import { type RpcSession } from "@iskra/client-runtime/rpc";
import { EnvironmentRegistry } from "@iskra/client-runtime/connection";
import { ManagedRelay } from "@iskra/client-runtime/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_ISKRA_RELAY_URL", "https://relay.example.test");
