...
import { pullRequestHostOf, resolveEnvironmentMachineKind } from "@iskra/contracts";
import type {
  EnvironmentId,
  ProjectId,
    ...
    <>
      {!capabilityKnown ? (
        ...
        <PullRequestsUnavailableState
          ...
          error="Update your Iskra servers to browse pull requests."
        />
      ) : firstLoad ? (
        <PullRequestListGhost rows={7} />
      ...
      {listQuery.error && entries.length > 0 ? (
        <div className="flex items-center justify-between gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 px-3 py-2 text-xs">
          ...
          <Button size="sm" variant="outline" onClick={() => listQuery.refresh()}>
            Retry
          </Button>
        </div>
      ) : null}
      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        {rightPanelPresent && renderedPullRequestSurface && panelEnvironmentId !== null ? (
          <RightPanelTabs
            ...
            widthStorageKey="iskra:pull-request-panel-width"
