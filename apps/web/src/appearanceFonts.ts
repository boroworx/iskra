...
export const DEFAULT_SANS_FONT_STACK =
  '"IBM Plex Sans Variable", -apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif';
...
export const TYPOGRAPHY_ADVANCED_STORAGE_KEY = "iskra:typography-advanced";
