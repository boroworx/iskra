...
/**
 * The skew a user can act on: the connected server runs an older Iskra than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Iskra version.",
  };
}
...
export function manualServerUpdateCommand(targetVersion: string): string {
  return `npx @iskra/cli@${targetVersion}`;
}
