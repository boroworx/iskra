...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@iskra/contracts";
...
/**
 * Post-sign-in onboarding wizard for Iskra Connect. Opens on every in-session
 ...
 * account's Iskra Connect environments so every device can be connected right
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Iskra Connect."
