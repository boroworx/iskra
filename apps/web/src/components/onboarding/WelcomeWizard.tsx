...
import { CommandId, ProviderDriverKind, ThreadId } from "@iskra/contracts";
...
import { useIskraConnectAuthPrompt } from "../clerk/useIskraConnectAuthPrompt";
...
function ConnectAccountOption({
  ...
  const { openAuthPrompt } = useIskraConnectAuthPrompt();
  ...
  return (
    <Collapsible open={expanded && !!isSignedIn && discoveryReady} onOpenChange={setExpanded}>
      ...
      >
        ...
        <span className="flex-1">Iskra Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command="npx @iskra/cli connect" className="mt-3" />
          <p className="mt-3 text-xs text-muted-foreground">
            Keep Iskra running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <CommandBlock command="npx @iskra/cli pair" className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Iskra first, or run <code className="font-mono">npx @iskra/cli serve</code>. Add{" "}
