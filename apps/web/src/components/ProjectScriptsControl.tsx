...
const NO_FILE_SCRIPTS: ReadonlyArray<IskraProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in iskra.json, offered for import. */
  fileScripts?: ReadonlyArray<IskraProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: IskraProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From iskra.json</MenuGroupLabel>
