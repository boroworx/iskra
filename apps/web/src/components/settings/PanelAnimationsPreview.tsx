...
export function PanelAnimationsPreview({ durationMs }: { durationMs: number }) {
  ...
  return (
    <button
      ...
      className="flex h-10 w-full cursor-pointer overflow-hidden rounded-lg bg-background p-1 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background"
