import { EnvironmentId, type IskraProjectFileScript } from "@iskra/contracts";
import {
...
export function ProjectActionsSettings() {
  ...
  // A project's iskra.json can declare actions to import. Read it from the
  ...
  const importableScripts = useMemo(
    ...
    [scripts, iskraFile.scripts],
  );
  const importFileScript = useCallback(
    async (fileScript: IskraProjectFileScript) => {
            ...
            {importableScripts.length > 0 ? (
              <Menu>
                ...
                <MenuPopup align="end" className="w-72">
                  <MenuGroup>
                    <MenuGroupLabel>Import from iskra.json</MenuGroupLabel>
