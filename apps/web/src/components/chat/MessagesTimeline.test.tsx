...
describe("MessagesTimeline", () => {
  ...
  it("anchors the first user message using its measured height", () => {
    ...
    expect(markup).toContain("iskra — Tests");
  ...
  it("does not render window details before the preview URL resolves", () => {
    ...
    expect(markup).not.toContain("iskra — Tests");
  ...
  it("does not render collapse controls for short user messages", () => {
    ...
    expect(markup).toContain("grid-cols-[32px_minmax(0,1fr)]");
  });
  ...
  it("renders unsafe user HTML as inert source text", async () => {
    ...
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        ...
        timelineEntries={[
          buildUserTimelineEntry(
            '<script>globalThis.__iskraXss = 1</script><img src="x" onerror="globalThis.__iskraXss = 2">',
          ),
        ]}
      />,
    );

    expect(markup).toContain("&lt;script&gt;globalThis.__iskraXss = 1&lt;/script&gt;");
    expect(markup).toContain(
      "&lt;img src=&quot;x&quot; onerror=&quot;globalThis.__iskraXss = 2&quot;&gt;",
    );
  ...
  it("sanitizes executable HTML while preserving supported assistant markup", async () => {
      ...
      <MessagesTimeline
        ...
        timelineEntries={[
          buildAssistantTimelineEntry(
            [
              '<details open onclick="globalThis.__iskraXss = 1">',
              "<summary>Safe details</summary>",
              "<script>globalThis.__iskraXss = 2</script>",
              '<img src="x" onerror="globalThis.__iskraXss = 3">',
              '<a href="javascript:globalThis.__iskraXss = 4">Unsafe link</a>',
              "</details>",
            ].join(""),
          ),
        ]}
    ...
    expect(markup).not.toContain("globalThis.__iskraXss");
  });
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/iskra/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/iskra"
      />,
    );

    expect(markup).toContain("Changed 1 file");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/iskra/apps/web/src/session-logic.ts");
  });
  ...
  it("renders attachment chips bound to server ids and hides their file rows", () => {
        ...
        timelineEntries={[
          {
            ...
            message: {
              ...
              role: "user",
              text: "See ![shot.png](iskra-context://v1/image/img-1) and [notes.txt](iskra-context://v1/file/file-1).",
              attachments: [
                {
                  type: "image",
                  id: "thread-1-aaa",
    ...
    expect(markup).toContain('data-markdown-copy="![shot.png](iskra-context://v1/image/img-1)"');
    ...
    expect(markup).not.toContain('href="iskra-context://');
        ...
        timelineEntries={[
          {
            ...
            message: {
              ...
              role: "user",
              text: "Compare [Terminal 1 line 4](iskra-context://v1/terminal/ctx-t) with [gone](iskra-context://v1/future/ctx-x).",
              context: {
                version: 1,
                records: [
                  {
