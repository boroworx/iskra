...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@iskra/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "iskra-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("iskra-assistant-citation") === highlighted) {
      CSS.highlights.delete("iskra-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("iskra-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "iskra-assistant-citation-pulse";
