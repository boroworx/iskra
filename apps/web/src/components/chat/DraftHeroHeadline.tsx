...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@iskra/contracts";
import { scopedProjectKey, scopeProjectRef } from "@iskra/client-runtime/environment";
...
export function DraftHeroHeadline({
  ...
  return (
    <h1 className="mx-auto w-full max-w-5xl text-center font-display font-normal text-xl text-foreground sm:text-2xl">
      {hasResolvedProject ? (
