    ...
    <SheetPortal keepMounted={keepMounted}>
      ...
      <SheetViewport className={viewportClassName} side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            "relative flex max-h-full min-h-0 w-full min-w-0 flex-col bg-popover text-popover-foreground shadow-[0_0_0_0.5px_var(--border),0_16px_48px_-12px_rgb(0_0_0/28%)] transition-[opacity,translate] duration-200 ease-in-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0 dark:shadow-[0_0_0_0.5px_rgb(255_255_255/8%),0_16px_48px_-12px_rgb(0_0_0/64%)]",
            side === "bottom" &&
            ...
            variant === "inset" &&
              "sm:rounded-[14px] sm:**:data-[slot=sheet-footer]:rounded-b-[14px]",
            instant &&
