import type { AuthSessionState } from "@iskra/contracts";
  ...
  return (
    <AuthSurfaceShell>
      <div className="flex flex-col items-center text-center">
        <h1 className="text-[22px] leading-tight font-bold tracking-[-0.015em]">
    ...
    <AuthSurfaceShell>
      <div className="flex flex-col items-center text-center">
        ...
        >
          ...
          {errorMessage ? (
            <div className="rounded-lg bg-destructive/12 px-3 py-2 text-[13px] text-destructive-foreground">
              {errorMessage}
            </div>
          ) : null}
  ...
  return (
    <AuthSurfaceShell>
      <div className="flex flex-col items-center text-center">
        ...
        {request ? (
          <div className="mt-5 w-full rounded-lg bg-muted px-3 py-2.5 text-xs leading-relaxed text-muted-foreground">
            Host: <span className="font-mono text-foreground/80">{request.host}</span>
          </div>
        ) : null}

        {status === "error" ? (
          <div className="mt-5 w-full rounded-lg bg-destructive/12 px-3 py-2 text-left text-[13px] text-destructive-foreground">
