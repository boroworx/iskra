import type { DiscoveredLocalServer, ScopedThreadRef } from "@iskra/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@iskra/client-runtime/state/runtime";
