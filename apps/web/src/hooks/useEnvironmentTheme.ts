import type { EnvironmentTheme } from "@iskra/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent Iskra palette rather than a foreign
 ...
 * than rendered: a published `iris.json` would show this palette on its
