...
import type { RuntimeMode } from "@iskra/contracts";
...
vi.mock("@iskra/client-runtime/environment", () => ({
  scopedProjectKey: () => "remote-project",
  scopeProjectRef: (environmentId: string, projectId: string) => ({ environmentId, projectId }),
  scopeThreadRef: (environmentId: string, threadId: string) => ({ environmentId, threadId }),
}));
vi.mock("@iskra/contracts", () => ({
  DEFAULT_RUNTIME_MODE: "default",
  DEFAULT_SERVER_SETTINGS: {},
}));
vi.mock("@iskra/shared/projectSettings", () => ({
...
vi.mock("@iskra/shared/threadEnvMode", () => ({
...
vi.mock("../lib/iskraProjectFileDefaults", () => ({
  readIskraProjectFileDefaultThreadEnvMode: () => testState.projectFileRead,
}));
vi.mock("../lib/utils", () => ({
