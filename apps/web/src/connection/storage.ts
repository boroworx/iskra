...
const DATABASE_NAME = "iskra:connection-runtime";
...
const GITHUB_ROUTING_KEY_PREFIX = "iskra:github-routing:";
const GITHUB_ROUTING_CHANGED = "iskra:github-routing-changed";
