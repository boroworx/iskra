import { ComposerContextRecord, ForwardCompatibleArray } from "@iskra/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "iskra:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "iskra:prompt-stash:v1";
