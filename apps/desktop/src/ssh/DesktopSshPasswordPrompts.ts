import type { DesktopSshPasswordPromptRequest } from "@iskra/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@iskra/contracts";
import type { SshPasswordRequest } from "@iskra/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Iskra window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@iskra/desktop/ssh/DesktopSshPasswordPrompts") {}
