...
const EXTENSION = "org.gnome.Shell.Extensions.IskraSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/IskraSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Iskra instance is capturing a window. Try again.");
    }
