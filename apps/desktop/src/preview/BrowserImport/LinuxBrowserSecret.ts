...
export const LinuxBrowserSecretPath = Context.Reference<string | undefined>(
  "@iskra/desktop/preview/BrowserImport/LinuxBrowserSecretPath",
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const relative = environment.path.join("browser-secret", "iskra-browser-secret");
