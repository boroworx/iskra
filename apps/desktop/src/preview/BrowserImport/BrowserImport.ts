 ...
 * into an IskraCode browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@iskra/contracts";
...
>()("@iskra/desktop/preview/BrowserImport/BrowserImport") {}
