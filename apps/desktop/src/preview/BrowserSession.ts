...
const PREVIEW_PARTITION_PREFIX = "persist:iskra-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "iskra-preview-ephemeral-";
...
>()("@iskra/desktop/preview/BrowserSession") {}
