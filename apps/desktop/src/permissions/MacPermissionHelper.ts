...
<header>↑ Drag Iskra into the list above</header>
<button id="app" draggable="true" aria-label="Drag Iskra to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Iskra</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Iskra icon is missing.");
