import { createAdvertisedEndpoint } from "@iskra/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@iskra/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@iskra/tailscale";
