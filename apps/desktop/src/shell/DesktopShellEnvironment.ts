...
>()("@iskra/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__ISKRA_ENV_${name}_START__`;
const endMarker = (name: string) => `__ISKRA_ENV_${name}_END__`;
