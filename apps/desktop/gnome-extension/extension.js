...
const NAME = "org.gnome.Shell.Extensions.IskraSnapShot";
const PATH = "/org/gnome/Shell/Extensions/IskraSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Iskra capture preview unavailable: ${error.message}`);
    }
  }
...
export default class IskraSnapShotExtension extends Extension {
  enable() {
