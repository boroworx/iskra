...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@iskra/contracts";
import { VcsUnsupportedOperationError } from "@iskra/contracts";
...
>()("@iskra/cli/vcs/VcsDriverRegistry") {}
