  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `iskra-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Iskra",
        GIT_AUTHOR_EMAIL: "iskra@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Iskra",
        GIT_COMMITTER_EMAIL: "iskra@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `iskra checkpoint ref=${input.checkpointRef}`;
