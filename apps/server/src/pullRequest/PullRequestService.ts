...
import { detectSourceControlProviderFromRemoteUrl } from "@iskra/shared/sourceControl";
...
} | null>("iskra/PullRequestService/routingCredential", { defaultValue: () => null });
...
>()("@iskra/cli/pullRequest/PullRequestService") {}
