...
import Migration0052 from "./Migrations/052_ProjectionAgents.ts";
import Migration0053 from "./Migrations/053_ProjectionChannels.ts";
import Migration0054 from "./Migrations/054_ProjectionRuns.ts";
import Migration0055 from "./Migrations/055_ProjectionRunsEndedAt.ts";
import Migration0056 from "./Migrations/056_ProjectionChannelDeliveries.ts";
import Migration0057 from "./Migrations/057_ProjectionCards.ts";
import Migration0058 from "./Migrations/058_ProjectionCardWorkspaces.ts";
import Migration0059 from "./Migrations/059_ProjectionCardSessions.ts";
import Migration0060 from "./Migrations/060_ProjectionCardSnooze.ts";
import Migration0061 from "./Migrations/061_ProjectionCardChecks.ts";
import Migration0062 from "./Migrations/062_ProjectionCardBudgets.ts";
import Migration0063 from "./Migrations/063_ProjectionCardAttempts.ts";
import Migration0064 from "./Migrations/064_ProjectionCardLinearIssues.ts";
import Migration0065 from "./Migrations/065_ProjectionChannelLeads.ts";
import Migration0066 from "./Migrations/066_ProjectionCardProposalReasoning.ts";
import Migration0067 from "./Migrations/067_ProjectionCardPriority.ts";
import Migration0068 from "./Migrations/068_ProjectionCardSuggestedAgent.ts";
import Migration0069 from "./Migrations/069_ProjectionProjectsOrchestration.ts";
import Migration0070 from "./Migrations/070_ProjectionCardActivities.ts";
import Migration0071 from "./Migrations/071_ProjectionCardContract.ts";
import Migration0072 from "./Migrations/072_ProjectionCardEvidence.ts";
import Migration0073 from "./Migrations/073_ProjectionRunsState.ts";
import Migration0074 from "./Migrations/074_ProjectionCardQuestions.ts";
import Migration0075 from "./Migrations/075_ProjectionCardActivityRefChanges.ts";
...
const migrationEntries = [
  ...
  [52, "ProjectionAgents", Migration0052],
  [53, "ProjectionChannels", Migration0053],
  [54, "ProjectionRuns", Migration0054],
  [55, "ProjectionRunsEndedAt", Migration0055],
  [56, "ProjectionChannelDeliveries", Migration0056],
  [57, "ProjectionCards", Migration0057],
  [58, "ProjectionCardWorkspaces", Migration0058],
  [59, "ProjectionCardSessions", Migration0059],
  [60, "ProjectionCardSnooze", Migration0060],
  [61, "ProjectionCardChecks", Migration0061],
  [62, "ProjectionCardBudgets", Migration0062],
  [63, "ProjectionCardAttempts", Migration0063],
  [64, "ProjectionCardLinearIssues", Migration0064],
  [65, "ProjectionChannelLeads", Migration0065],
  [66, "ProjectionCardProposalReasoning", Migration0066],
  [67, "ProjectionCardPriority", Migration0067],
  [68, "ProjectionCardSuggestedAgent", Migration0068],
  [69, "ProjectionProjectsOrchestration", Migration0069],
  [70, "ProjectionCardActivities", Migration0070],
  [71, "ProjectionCardContract", Migration0071],
  [72, "ProjectionCardEvidence", Migration0072],
  [73, "ProjectionRunsState", Migration0073],
  [74, "ProjectionCardQuestions", Migration0074],
  [75, "ProjectionCardActivityRefChanges", Migration0075],
