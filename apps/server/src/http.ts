...
import { isDevProxiedPath } from "@iskra/shared/devProxy";
import { decodeOtlpTraceRecords } from "@iskra/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["iskra://app", "iskra-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // ISKRA_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
