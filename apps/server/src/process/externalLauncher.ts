...
// per-command cache lookups in @iskra/shared/shell.
//
...
// command-resolution cache in @iskra/shared/shell, so a backward wall-clock
...
>()("@iskra/cli/process/externalLauncher") {}
