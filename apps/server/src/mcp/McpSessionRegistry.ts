import { ProviderInstanceId, ThreadId } from "@iskra/contracts";
...
>()("@iskra/cli/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the `iskra` toolkits on a remote-reachable server.
 */
  ...
  const issue: McpSessionRegistryShape["issue"] = Effect.fn("McpSessionRegistry.issue")(
    function* (request) {
      ...
      const scope: McpInvocationContext.McpInvocationScope = {
        ...
        capabilities: new Set<McpInvocationContext.McpCapability>(request.capabilities),
        issuedAt,
      };
