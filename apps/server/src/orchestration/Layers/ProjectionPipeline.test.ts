...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("iskra-projection-pipeline-test-");
const encodeThreadLinkedPullRequest = Schema.encodeSync(
  Schema.fromJsonString(ThreadLinkedPullRequest),
);

it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-cursor-batch-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-import-shell-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-branch-pr-projection-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-base-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-pull-requests-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-safe-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-revert-files/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-revert-files/turn/2"),
          status: "ready",
          files: [],
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("iskra-projection-attachments-replay-")),
)("OrchestrationProjectionPipeline", (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
      ...
      const refreshEvents = [
        ...
        },
        {
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-shell-summary-1"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-shell-summary/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/iskra/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
...
it.layer(makeProjectionPipelinePrefixedTestLayer("iskra-pending-turn-terminal-test-"))(
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "iskra-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "iskra-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
  ...
  it.effect("projects every card, agent and channel event the same in memory and in SQL", () =>
    Effect.gen(function* () {
      ...
      > = [
        ...
        // What waits on a person: a comment to forward stays, missing checks are dismissed.
        [
          "card.activity-recorded",
          card1,
          {
            ...noActivityParts,
            activityId: "activity-untrusted-comment",
            cardId: card1,
            kind: "message",
            author: { kind: "github", id: "stranger", trusted: false },
            body: "stranger on the pull request: Use tabs.",
            reason: { code: "untrustedComment", text: "stranger can't direct work here." },
            createdAt: at(66),
          },
        ],
        [
          ...
          {
            ...noActivityParts,
            activityId: "activity-checks-missing",
            cardId: card1,
            kind: "error",
            author: { kind: "system", id: "system" },
            body: "This project has no checks.",
            reason: { code: "checksMissing", text: "No checks." },
            createdAt: at(66),
          },
        ],
        [
          ...
          {
            ...noActivityParts,
            activityId: "activity-checks-missing:dismissed",
            cardId: card1,
            kind: "response",
            author: human,
            body: "Dismissed.",
            answers: { questionId: "activity-checks-missing", optionId: "dismiss" },
            createdAt: at(66),
          },
        ],
