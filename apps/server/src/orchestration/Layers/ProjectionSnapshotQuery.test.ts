    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'boroworx/iskra',
            41,
            'https://github.com/boroworx/iskra/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"boroworx/iskra","number":41,"url":"https://github.com/boroworx/iskra/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "boroworx/iskra",
          number: 41,
          url: "https://github.com/boroworx/iskra/pull/41",
          source: "created",
