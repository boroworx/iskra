...
import { SourceControlProviderError, type ChangeRequest } from "@iskra/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set ISKRA_BITBUCKET_EMAIL and ISKRA_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
