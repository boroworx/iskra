...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@iskra/contracts";
...
const owner = "iskra-auth-session-owner";
const otherOwner = "iskra-auth-session-other";
