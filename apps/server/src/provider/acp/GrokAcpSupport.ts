import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@iskra/contracts";
...
import { normalizeModelSlug } from "@iskra/shared/model";
...
const ISKRA_CODE_OAUTH_REFERRER = "iskra";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: ISKRA_CODE_OAUTH_REFERRER,
    },
  };
}
