...
export function makeOpenCodeAdapter(
  ...
  return Effect.gen(function* () {
    ...
    // Iskra supplies the message ID to match prompt admission events. Keep OpenCode's sortable native shape so equal-time messages retain their upstream order.
