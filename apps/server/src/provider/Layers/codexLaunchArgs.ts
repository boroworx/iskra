import { tokenizeCliArgs } from "@iskra/shared/cliArgs";

const ISKRA_CODEX_LAUNCH_ARGS_ENV = "ISKRA_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[ISKRA_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
