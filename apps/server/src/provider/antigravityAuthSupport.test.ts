...
describe("Antigravity process environment", () => {
  const profile: AntigravityProfile = {
    platform: "linux",
    geminiHome: "/iskra/userdata/providers/antigravity/profile",
    acpDirectory: "/iskra/userdata/providers/antigravity/profile/antigravity-acp",
    tokenPath: "/iskra/userdata/providers/antigravity/profile/antigravity-acp/acp_token.json",
