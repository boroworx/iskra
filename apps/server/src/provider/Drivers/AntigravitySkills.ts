...
import type { ServerProviderSkill } from "@iskra/contracts";
 ...
 * `os.path.expanduser` in the launch environment Iskra hands the process:
 ...
 * skills. The agent resolves both under `GEMINI_HOME`, which Iskra points at a
