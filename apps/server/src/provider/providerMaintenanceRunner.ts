...
>()("@iskra/cli/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Iskra could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Iskra still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
