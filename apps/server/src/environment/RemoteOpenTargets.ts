 ...
 */
import { type RemoteOpenTarget } from "@iskra/contracts";
import { HostProcessHostname } from "@iskra/shared/hostProcess";
import * as NetService from "@iskra/shared/Net";
import { readTailscaleStatus } from "@iskra/tailscale";
...
>()("@iskra/cli/environment/RemoteOpenTargets") {}
