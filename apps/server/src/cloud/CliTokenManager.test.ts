import { readConnectAuthorizeRequest } from "@iskra/shared/connectAuth";
...
const TEST_ENV = {
  ISKRA_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  ISKRA_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  ISKRA_HOSTED_APP_URL: "https://hosted.example.test",
};
