...
declare const __ISKRA_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __ISKRA_BUILD_CHANNEL__ === "undefined" ? "dev" : __ISKRA_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Iskra (Dev)",
  nightly: "Iskra (Nightly)",
  latest: "Iskra",
...
<html lang="en">
  <head>
    ...
    <title>Iskra Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Iskra Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
