...
const rule = createOxlintRuleHarness("iskra/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("iskra/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Iskra";`);
