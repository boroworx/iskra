...
const guardedMobileFile = createOxlintRuleHarness("iskra/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "iskra/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("iskra/no-mobile-uniwind-theme-escape-hatches", () => {
