...
const rule = createOxlintRuleHarness("iskra/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("iskra/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("iskra/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("iskra/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("iskra/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
